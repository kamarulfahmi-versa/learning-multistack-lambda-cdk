...
export class BackendStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const lambda1 = new lambdaNodejs.NodejsFunction(this, 'Lambda1Function', {
      ...
      entry: path.join(__dirname, '../../src/lambda-handlers/backend/lambda1/index.ts'),
      handler: 'handler',
    });
    ...
    const lambda2 = new lambdaNodejs.NodejsFunction(this, 'Lambda2Function', {
      ...
      runtime: lambda.Runtime.NODEJS_LATEST,
      entry: path.join(__dirname, '../../src/lambda-handlers/backend/lambda2/index.ts'),
      handler: 'handler',
    });
    ...
    const lambda3 = new lambdaNodejs.NodejsFunction(this, 'Lambda3Function', {
      ...
      runtime: lambda.Runtime.NODEJS_LATEST,
      entry: path.join(__dirname, '../../src/lambda-handlers/backend/lambda3/index.ts'),
      handler: 'handler',
    });
